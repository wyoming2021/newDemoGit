...
import com.app.video.videoapps.utils.LogUtils;
import com.app.video.videoapps.utils.Md5Util;
import com.app.video.videoapps.utils.ZipHelper;
...
import static com.app.video.videoapps.http.AppConfig.KEY;
...
//        String timestamp = System.currentTimeMillis() + "";
        ...
        if (!request.url().toString().contains("getUserTokenByRandomnum")) {
            ...
            if ("POST".equals(method)) {
                ...
                formBodyBuilder.add("signature", Md5Util.getMD5(randomstr + timestamp.toString() + KEY).toLowerCase());
                ...
                queryParamsMap.put("signature", Md5Util.getMD5(randomstr + timestamp.toString() + KEY).toLowerCase());
